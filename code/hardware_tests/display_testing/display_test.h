...
public:
    ...
    void show_test_in_progress(int run_time[], unsigned long time_elapsed, unsigned long recent_val, char file_name[], float avg_slope); // displays screen with time elapsed and active trendline
