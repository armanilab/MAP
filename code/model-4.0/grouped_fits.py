...
# assume this file has multiple files listed on each line
...
for f in to_run_list:
    ...
    file_lines.append('Files: ' + file_names)
    ...
    for g in group:
        ...
        processed_data.append([time_shifted, conc_shifted])
    ...
    ### SAVE RESULTS
    if to_save:
        with open(save_dir + file_names + '-fit' + file_suffix + '.txt', 'w') as f:
            for l in file_lines:
                f.write(l + '\n')
