# Makes a simple plot of the data fit
# Lexie Scholtz
# Created: 2022.11.02
...
for file in file_list:
    ...
    # plot data
    #plt.plot(data[:, 0], data[:, 1], label=file[-12:], alpha=0.75)
    plt.plot(data[:, 0], data[:, 1], marker='.', markersize=2, linestyle='None', label=file[-12:], alpha=0.1)
    plt.plot(data[:, 2], data[:, 3], marker='.', markersize=2, linestyle='None', label="Fit", alpha=0.1)
